...
for o in O.bodies:
	if isinstance(O.bodies[o.id].shape,Sphere):
		...
		#print a.bound.refPos[2]
   		if (((O.bodies[o.id].bound.refPos[0]+O.bodies[o.id].bound.refPos[1])>0.4) and ((O.bodies[o.id].bound.refPos[0]+O.bodies[o.id].bound.refPos[1])<0.8)) or (((O.bodies[o.id].bound.refPos[0]+O.bodies[o.id].bound.refPos[1])>1.2) and ((O.bodies[o.id].bound.refPos[0]+O.bodies[o.id].bound.refPos[1])<1.6)):
			nb24+=1
