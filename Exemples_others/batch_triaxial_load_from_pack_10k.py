...
utils.readParamsFromTable(sigma3_conf=-10e6,finalFricDegree=18,MAX=80000, RATE=-0.02,OUT='load_from_pack_10k_422e9default',noTableOk=True)
...
TENS=T
COH=C
finalFricDegree=finalFricDegree
